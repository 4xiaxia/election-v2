...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'positions', name: 'Positions', component: () => import('@/views/positions/index.vue'), meta: { title: '岗位管理', roles: ['超级管理', '经办'] } },
      ...
      { path: 'materials', name: 'Materials', component: () => import('@/views/materials/index.vue'), meta: { title: '材料提交审核', roles: ['超级管理', '经办', '审核'] } },
      { path: 'notices', name: 'Notices', component: () => import('@/views/notices/index.vue'), meta: { title: '子公告管理', roles: ['超级管理', '经办', '运营'] } },
      { path: 'notifications', name: 'Notifications', component: () => import('@/views/notifications/index.vue'), meta: { title: '通知管理', roles: ['超级管理', '经办', '运营'] } },
      { path: 'election-methods', name: 'ElectionMethods', component: () => import('@/views/election-proposals/index.vue'), meta: { title: '选举提案审批', roles: ['超级管理', '经办'] } },
      { path: 'archives', name: 'Archives', component: () => import('@/views/archives/index.vue'), meta: { title: '历史归档', roles: ['超级管理', '经办', '运营'] } },
      { path: 'admins', name: 'Admins', component: () => import('@/views/admins/index.vue'), meta: { title: '管理员', roles: ['超级管理'] } },
      { path: 'roles', name: 'Roles', component: () => import('@/views/roles/index.vue'), meta: { title: '用户管理', roles: ['超级管理'] } },
      { path: 'settings', name: 'Settings', component: () => import('@/views/settings/index.vue'), meta: { title: '系统配置', roles: ['超级管理'] } },
